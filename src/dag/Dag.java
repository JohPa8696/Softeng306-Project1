...
public class Dag implements ViewerListener {
	...
	/**
	 * Create a processor graph which shows the order and the allocation of the
	 * node. User could click on a node to see the starting time.
	 */
	 ...
	 * @param node
	 * @param color
	 *            Change the node color after the node's processor is
	 *            determined.
	 */
	...
	/**
	 * @param n
	 *            - Passing the node which is determined Update the processor
	 *            graph and store the information inside the node.
	 */
